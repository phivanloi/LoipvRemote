...
You can hide the Menu Container when right-clicking the LoipvRemote title bar.
...
In this section we are going to explain the menus located in LoipvRemote.
...
.. list-table::
   ...
   * - Reconnect All Open Connections
     - Sends a reconnect to all the open connections in LoipvRemote.
   * - Exit
     - Exit LoipvRemote application

View Menu
---------
Menu for additional dialogs for LoipvRemote.
...
.. list-table::
   ...
   * - Fullscreen
     - Fullscreen LoipvRemote (will not fullscreen connection window but only the LoipvRemote application)

Tools Menu
----------
Additional tools that can be used and triggered in LoipvRemote.
...
.. list-table::
   ...
   * - Options
     - Opens LoipvRemote global settings and options dialog
...
.. list-table::
   ...
   * - Website
     - Go to LoipvRemote website
   * - Donate
     - Go to LoipvRemote donation page
   * - Support Forum
     - Go to LoipvRemote suport forum
   * - Report a Bug
     - Go to github page to report a bug
   * - Check for Updates
     - Opens dialog to check for any updates of LoipvRemote
   * - About
     - Open about dialog for LoipvRemote (Shows contributors, changelog and more)
