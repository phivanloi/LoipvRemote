...
Folders on LoipvRemote cannot only be used to categorize connections but also to inherit
...
In LoipvRemote there is an easier way. You just create two folders
