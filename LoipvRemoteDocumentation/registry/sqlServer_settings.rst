...
- **Registry Path:** ``SOFTWARE\LoipvRemote\SQLServer\Options``
...
.. code::
    ...
    [HKEY_LOCAL_MACHINE\SOFTWARE\LoipvRemote\SQLServer]

    [HKEY_LOCAL_MACHINE\SOFTWARE\LoipvRemote\SQLServer\Options]
    "UseSQLServer"="false"
    "SQLDatabaseName"=""
    "SQLReadOnly"="true"
    "SQLUser_"=""
