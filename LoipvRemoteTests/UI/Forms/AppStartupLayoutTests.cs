...
namespace LoipvRemoteTests.UI.Forms
{
    ...
    {
        [Test]
        public void UsesChatStyleSidebarWidthAtStandardDpi()
        {
            Assert.That(AppStartupLayout.SidebarWidthForDpi(96), Is.EqualTo(320));
        }

        [Test]
        public void ScalesSidebarWidthWithDpi()
        {
            Assert.That(AppStartupLayout.SidebarWidthForDpi(120), Is.EqualTo(400));
        }
