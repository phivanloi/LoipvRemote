...
- Registry Path: ``SOFTWARE\LoipvRemote\Updates``
...
- **Registry Hive:** ``HKEY_LOCAL_MACHINE``
- **Registry Path:** ``SOFTWARE\LoipvRemote\Updates\Options``
...
.. code::
    ...
    [HKEY_LOCAL_MACHINE\SOFTWARE\LoipvRemote\Updates]
    "AllowCheckForUpdates"="false"
    "AllowCheckForUpdatesAutomatical"="false"
    "AllowCheckForUpdatesManual"="false"


    [HKEY_LOCAL_MACHINE\SOFTWARE\LoipvRemote\Updates\Options]
