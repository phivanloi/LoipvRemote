...
namespace LoipvRemote.Config.Settings
{
    ...
    public class ExternalAppsLoader
    {
        ...
        private readonly IExternalToolRuntime _externalToolRuntime;
            ...
            IExternalToolRuntime externalToolRuntime)
        {
            ...
            _externalToolRuntime = externalToolRuntime ?? throw new ArgumentNullException(nameof(externalToolRuntime));
        }
