...
{
    //Extracts the extended LoipvRemote colors from a Visual Studio theme file.
    public class LoipvRemotePaletteManipulator
    {
        ...
        public LoipvRemotePaletteManipulator(byte[] file, ExtendedColorPalette? defaultPalette = null)
        {
        ...
        //Load the colors for the LoipvRemote own components as Dockpanel only have a menus and docks palette
