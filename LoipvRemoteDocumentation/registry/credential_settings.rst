...
- Registry Path: ``SOFTWARE\LoipvRemote\Credentials``
...
- **Registry Hive:** ``HKEY_LOCAL_MACHINE``
- **Registry Path:** ``SOFTWARE\LoipvRemote\Credentials\Options``
...
.. code::
  ...
  [HKEY_LOCAL_MACHINE\SOFTWARE\LoipvRemote\Credentials]
  "AllowExportPasswords"="false"
  "AllowExportUsernames"="false"
  "AllowSavePasswords"="false"
  "AllowSaveUsernames"="false"

  [HKEY_LOCAL_MACHINE\SOFTWARE\LoipvRemote\Credentials\Options]
