...
public sealed class ConnectionStoreUpdateChecker(ConnectionsService connectionsService, MessageCollector messageCollector) : IConnectionsUpdateChecker
{
    ...
    public bool IsUpdateAvailable()
    {
        ...
        try
        {
            string revision = _connectionsService.GetDatabaseRevision();
