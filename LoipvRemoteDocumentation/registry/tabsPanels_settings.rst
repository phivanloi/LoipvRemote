...
- **Registry Path:** ``SOFTWARE\LoipvRemote\TabsAndPanels\Options``
...
.. code::
  ...
  [HKEY_LOCAL_MACHINE\SOFTWARE\LoipvRemote\TabsAndPanels]

  [HKEY_LOCAL_MACHINE\SOFTWARE\LoipvRemote\TabsAndPanels\Options]
