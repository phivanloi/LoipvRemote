...
namespace LoipvRemote.UI.Tabs
{
    ...
    internal sealed class LoipvRemoteAutoHideStrip : AutoHideStripBase
    {
        ...
        public LoipvRemoteAutoHideStrip(DockPanel panel)
            : base(panel)
        {
        ...
        private void DrawTab(Graphics g, TabNG tab)
        {
            ...
            using (Matrix matrixRotate = g.Transform)
            {
                ...
                if (content is Form { Icon: { } formIcon })
                {
                    if (dockState == DockState.DockLeftAutoHide || dockState == DockState.DockRightAutoHide)
                    {
                        ...
                        using (Icon rotatedIcon = new(formIcon, 16, 16))
                        {
                    ...
                    else
                    {
                        ...
                        g.DrawIcon(formIcon, RtlTransform(rectImage, dockState));
                    }
                }
