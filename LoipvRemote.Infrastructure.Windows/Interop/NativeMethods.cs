...
namespace LoipvRemote.Infrastructure.Windows.Interop
{
    ...
    public static class NativeMethods
    {
        ...
        public static WINDOWPOS ReadWindowPosition(IntPtr pointer) => Marshal.PtrToStructure<WINDOWPOS>(pointer);
        ...
        [DllImport("user32.dll", CharSet = CharSet.Unicode)]
        public static extern IntPtr SendMessage([In] IntPtr hWnd,
                                                  [In] uint msg,
        ...
        [DllImport("user32.dll", SetLastError = true, CharSet = CharSet.Unicode)]
        public static extern bool SetMenuItemBitmaps(IntPtr hMenu,
                                                       int uPosition,
                                                       int uFlags,
