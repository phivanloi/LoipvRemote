...
and take screenshots inside LoipvRemote.
...
Clicking the screenshot there will allow LoipvRemote to create a screenshot.

The second image is where the screenshots are stored in LoipvRemote.
