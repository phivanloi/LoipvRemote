...
namespace LoipvRemote.Themes
{
    ...
    /// </summary>
    public class LoipvRemoteThemeBase : VS2015ThemeBase
    {
        public LoipvRemoteThemeBase(byte[] themeResource)
            : base(themeResource)
        {
    ...
    [SupportedOSPlatform("windows")]
    public class LoipvRemoteDockPaneStripFactory : DockPanelExtender.IDockPaneStripFactory
    {
    ...
    public class LoipvRemoteFloatWindowFactory : DockPanelExtender.IFloatWindowFactory
    {
