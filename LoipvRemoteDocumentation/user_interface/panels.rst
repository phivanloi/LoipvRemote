...
LoipvRemote is using tabs and panels to stay organized but also to create
...
Creating manual panels will make you able to organize tabs manually in LoipvRemote.
...
that are available in LoipvRemote window.
...
- **Send to...** - Send the whole panel to monitor/screen *[number]*. Note this is not a real window but a detachable panel. If you double click the title then the panel will go back to LoipvRemote window and not fullscreen the window.
