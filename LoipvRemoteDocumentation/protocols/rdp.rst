...
There are several versions of the RDP protocol supported in LoipvRemote. Each newer protocol adds support for additional connection properties. By default, RDP connections will attempt to use the highest RDP protocol version supported by both LoipvRemote and your machine. You can manually select a protocol version using the ``RDP Protocol Version`` connection property.

.. note::
	The ability to select the RDP protocol version was added in LoipvRemote v1.77.1. The RDP 8 protocol was used from LoipvRemote v1.74.0 to v1.77.0. RDP 5 was used in v1.73 and earlier.
