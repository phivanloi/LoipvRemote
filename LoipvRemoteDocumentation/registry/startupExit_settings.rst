...
- **Registry Path:** ``SOFTWARE\LoipvRemote\StartupExit\Options``
...
.. code::
    ...
    [HKEY_LOCAL_MACHINE\SOFTWARE\LoipvRemote\StartupExit]

    [HKEY_LOCAL_MACHINE\SOFTWARE\LoipvRemote\StartupExit\Options]
