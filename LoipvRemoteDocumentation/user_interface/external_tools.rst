...
External Tools can help you get things done that can't be done in LoipvRemote.
...
But from within LoipvRemote you can launch applications and tell them what to do with the use of arguments, parameters and variables
...
Arguments
   ...
   And also which variables from LoipvRemote to use for the arguments.
