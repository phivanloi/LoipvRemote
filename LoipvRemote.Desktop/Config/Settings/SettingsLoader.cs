...
namespace LoipvRemote.Config.Settings
{
    ...
    public class SettingsLoader
    {
            ...
            IExternalToolRuntime externalToolRuntime)
        {
            ...
            _externalAppsLoader = new ExternalAppsLoader(MainForm, messageCollector, _externalToolsToolStrip, _desktopShellRuntime.ExternalToolsService, externalToolRuntime);
        }
