...
namespace LoipvRemote.UI.TaskDialog
{
  partial class frmTaskDialog
  {
    ...
    private void InitializeComponent()
    {
            ...
            this.lbFooter = new LoipvRemote.UI.Controls.MrngLabel();
            this.bt1 = new MrngButton();
            this.bt2 = new MrngButton();
            this.bt3 = new MrngButton();
            this.cbVerify = new MrngCheckBox();
            this.lbShowHideDetails = new LoipvRemote.UI.Controls.MrngLabel();
            this.lbExpandedInfo = new LoipvRemote.UI.Controls.MrngLabel();
            this.lbContent = new LoipvRemote.UI.Controls.MrngLabel();
            this.lbMainInstruction = new LoipvRemote.UI.Controls.MrngLabel();
