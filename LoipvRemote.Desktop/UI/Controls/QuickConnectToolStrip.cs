...
namespace LoipvRemote.UI.Controls
{
    ...
    public class QuickConnectToolStrip : ToolStrip
    {
        ...
        private WeifenLuo.WinFormsUI.Docking.VisualStudioToolStripExtender vsToolStripExtender = null!;
        ...
        private void PopulateQuickConnectProtocolMenu()
        {
            try
            {
                ...
                foreach (System.Reflection.FieldInfo fieldInfo in typeof(ProtocolKind).GetFields())
                {
        ...
        private void btnQuickConnect_ButtonClick(object? sender, EventArgs e)
        {
            try
            {
                ConnectionInfo? connectionInfo = DesktopShellRuntime.ConnectionTreeWorkspace.CreateQuickConnect(_cmbQuickConnect.Text.Trim(),
        ...
        private void btnConnections_DropDownOpening(object? sender, EventArgs e)
        {
            ...
            ToolStripItem[] rootMenuItems = menuItemsConverter
                                            .CreateToolStripDropDownItems(DesktopShellRuntime.ConnectionTreeWorkspace
            ...
            List<ContainerInfo> rootNodes = DesktopShellRuntime.ConnectionTreeWorkspace.ConnectionTreeModel.RootNodes;
