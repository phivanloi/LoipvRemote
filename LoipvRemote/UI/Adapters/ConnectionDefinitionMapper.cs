...
public static class ConnectionDefinitionMapper
{
        ...
        Func<ConnectionInfo, ExternalApplicationDefinition?>? externalApplicationResolver = null)
    {
        ...
        {
            ProtocolKind protocol = MapProtocol(connection.Protocol);
        ...
        Func<string, string, string, string>? unprotectSecret = null)
    {
        ...
        foreach (ConnectionDefinition definition in tree.Connections.OrderBy(connection => connection.SortOrder))
        {
            ...
            connection.Protocol = MapProtocol(definition.Protocol);
    ...
    private static ProtocolKind MapProtocol(ProtocolType protocol) => protocol switch
    {
        ProtocolType.RDP => ProtocolKind.Rdp,
        ProtocolType.VNC => ProtocolKind.Vnc,
        ProtocolType.ARD => ProtocolKind.Ard,
        ProtocolType.SSH1 => ProtocolKind.Ssh1,
        ProtocolType.SSH2 => ProtocolKind.Ssh2,
        ProtocolType.Telnet => ProtocolKind.Telnet,
        ProtocolType.Rlogin => ProtocolKind.Rlogin,
        ProtocolType.RAW => ProtocolKind.Raw,
        ProtocolType.HTTP => ProtocolKind.Http,
        ProtocolType.HTTPS => ProtocolKind.Https,
        ProtocolType.PowerShell => ProtocolKind.PowerShell,
        ProtocolType.Terminal => ProtocolKind.Terminal,
        ProtocolType.WSL => ProtocolKind.Wsl,
        ProtocolType.AnyDesk => ProtocolKind.AnyDesk,
        ProtocolType.IntApp => ProtocolKind.ExternalApplication,
        _ => throw new ArgumentOutOfRangeException(nameof(protocol), protocol, "Unsupported protocol type.")
    };
    ...
    private static ProtocolType MapProtocol(ProtocolKind protocol) => protocol switch
    {
        ...
        ProtocolKind.Http => ProtocolType.HTTP,
        ...
        ProtocolKind.ExternalApplication => ProtocolType.IntApp,
        _ => throw new ArgumentOutOfRangeException(nameof(protocol), protocol, "Unsupported protocol kind.")
    };
