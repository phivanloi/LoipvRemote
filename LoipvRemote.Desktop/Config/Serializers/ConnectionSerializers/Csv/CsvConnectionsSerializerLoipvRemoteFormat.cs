...
namespace LoipvRemote.Config.Serializers.ConnectionSerializers.Csv
{
    ...
    public class CsvConnectionsSerializer : ISerializer<ConnectionInfo, string>
    {
        ...
        public CsvConnectionsSerializer(SaveFilter saveFilter,
        ...
        {
            string cleanedString = (value?.ToString() ?? string.Empty).Replace(";", "", StringComparison.Ordinal);
