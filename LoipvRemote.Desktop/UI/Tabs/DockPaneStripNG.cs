...
namespace LoipvRemote.UI.Tabs
{
    ...
    /// <summary>
    /// This class is lifted from VS2013DockPaneStrip from DockPanelSuite and customized for LoipvRemote.
    /// </summary>
    [ToolboxItem(false)]
    internal class DockPaneStripNG : DockPaneStripBase
    {
        private class LoipvRemoteTab(IDockContent content) : Tab(content)
        {
        ...
        {
            return new LoipvRemoteTab(content);
        }
        ...
        private InertButton m_buttonOverflow = null!;
        ...
        private void CalculateTabs_ToolWindow()
        {
            ...
            {
                LoipvRemoteTab tab = (LoipvRemoteTab)tab1;
        ...
        private bool CalculateDocumentTab(Rectangle rectTabStrip, ref int x, int index)
        {
            ...
            if (!(Tabs[index] is LoipvRemoteTab tab)) return false;
        ...
        private void CalculateTabs_Document()
        {
            ...
            {
                int tempX = x;
                if (Tabs[m_startDisplayingTab] is LoipvRemoteTab tab)
        ...
        private bool EnsureDocumentTabVisible(IDockContent content, bool repaint)
        {
            ...
            if (Tabs[index] is LoipvRemoteTab tab && tab.TabWidth != 0)
                return false;
        ...
        private Rectangle GetTabRectangle_ToolWindow(int index)
        {
            ...
            LoipvRemoteTab tab = (LoipvRemoteTab)Tabs[index];
        ...
        private void DrawTab(Graphics g, LoipvRemoteTab tab)
        {
            if (Appearance == DockPane.AppearanceStyle.ToolWindow)
        ...
        private void DrawTab_ToolWindow(Graphics g, LoipvRemoteTab tab)
        {
        ...
        private void DrawTab_Document(Graphics g, LoipvRemoteTab tab)
        {
            if (tab.Rectangle == null) return;
            Rectangle rect = tab.Rectangle.Value;
            if (tab.TabWidth == 0)
        ...
        protected override void OnMouseMove(MouseEventArgs e)
        {
            ...
            if (index != -1)
            {
                if (Tabs[index] is LoipvRemoteTab tab)
                {
                    if (Appearance == DockPane.AppearanceStyle.ToolWindow ||
                        Appearance == DockPane.AppearanceStyle.Document)
                    {
