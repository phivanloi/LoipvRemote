...
.. note::
	Currently, default connection properties are saved within the user settings of LoipvRemote and not with the connection file. Sharing a connection file between multiple machines will not share default connection properties.
