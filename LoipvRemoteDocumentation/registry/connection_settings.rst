...
- **Registry Path:** ``SOFTWARE\LoipvRemote\Connections\Options``
...
.. code::
    ...
    [HKEY_LOCAL_MACHINE\SOFTWARE\LoipvRemote\Connections]

    [HKEY_LOCAL_MACHINE\SOFTWARE\LoipvRemote\Connections\Options]
