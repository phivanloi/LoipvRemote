...
The notifications panel contains any errors or informational messages that LoipvRemote triggers.
...
This will tell LoipvRemote what type of messages and the level of messages to send to the panel. It does not the level for the log that LoipvRemote has but only for panel output.
...
Good when for example reporting issues about LoipvRemote or to check more details about problems.
