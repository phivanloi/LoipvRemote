...
- **Registry Path:** ``SOFTWARE\LoipvRemote\Appearance\Options``
...
.. code::
    ...
    [HKEY_LOCAL_MACHINE\SOFTWARE\LoipvRemote\Appearance]

    [HKEY_LOCAL_MACHINE\SOFTWARE\LoipvRemote\Appearance\Options]
