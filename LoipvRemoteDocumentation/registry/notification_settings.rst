...
- **Registry Path:** ``SOFTWARE\LoipvRemote\Notifications``
...
- **Registry Hive:** ``HKEY_LOCAL_MACHINE``
- **Registry Path:** ``SOFTWARE\LoipvRemote\Notifications\Options``
...
.. code::
    ...
    [HKEY_LOCAL_MACHINE\SOFTWARE\LoipvRemote\Notifications]
    "AllowLogging"="false"
    "AllowNotifications"="false"
    "AllowPopups"="false"

    [HKEY_LOCAL_MACHINE\SOFTWARE\LoipvRemote\Notifications\Options]
