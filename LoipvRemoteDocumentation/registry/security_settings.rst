...
- **Registry Path:** ``SOFTWARE\LoipvRemote\Security\Options``
...
.. code::
  ...
  [HKEY_LOCAL_MACHINE\SOFTWARE\LoipvRemote\Security]

  [HKEY_LOCAL_MACHINE\SOFTWARE\LoipvRemote\Security\Options]
