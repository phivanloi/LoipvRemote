    ...
    public class DialogFactory
    {
        public static OpenFileDialog BuildLoadConnectionsDialog()
        {
            return new OpenFileDialog
            {
                ...
                Filter = "LoipvRemote XML (*.xml)|*.xml|" + Language.FilterAll + @"|*.*"
            };
        }
        ...
        public static void ShowLoadConnectionsFailedDialog(
            string connectionFileName,
            string messageText,
            bool showCancelButton,
            IConnectionTreeWorkspace connectionWorkspace,
            Action<bool> reloadConnections,
            MessageCollector messageCollector)
        {
            ArgumentNullException.ThrowIfNull(connectionWorkspace);
            ArgumentNullException.ThrowIfNull(reloadConnections);
        ...
        /// <summary>
        /// Creates a new dialog that allows the user to select an LoipvRemote
