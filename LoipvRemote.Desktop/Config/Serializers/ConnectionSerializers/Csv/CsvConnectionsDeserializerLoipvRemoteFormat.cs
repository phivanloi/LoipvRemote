...
namespace LoipvRemote.Config.Serializers.ConnectionSerializers.Csv
{
    ...
    public class CsvConnectionsDeserializer : IDeserializer<string, ConnectionTreeModel>
    {
        ...
        private static ConnectionInfo ParseConnectionInfo(List<string> headers, string[] connectionCsv)
        {
            ...
            {
                if (Enum.TryParse(connectionCsv[headers.IndexOf("Protocol")], out ProtocolKind protocolType))
            ...
            {
                if (Enum.TryParse(connectionCsv[headers.IndexOf("RenderingEngine")], out BrowserRenderingEngine value))
            ...
            {
                if (Enum.TryParse(connectionCsv[headers.IndexOf("VNCCompression")], out VncCompression value))
                    connectionRecord.VNCCompression = value;
            }

            if (headers.Contains("VNCEncoding"))
            {
                if (Enum.TryParse(connectionCsv[headers.IndexOf("VNCEncoding")], out VncEncoding value))
                    connectionRecord.VNCEncoding = value;
            }

            if (headers.Contains("VNCAuthMode"))
            {
                if (Enum.TryParse(connectionCsv[headers.IndexOf("VNCAuthMode")], out VncAuthMode value))
                    connectionRecord.VNCAuthMode = value;
            }

            if (headers.Contains("VNCProxyType"))
            {
                if (Enum.TryParse(connectionCsv[headers.IndexOf("VNCProxyType")], out VncProxyType value))
            ...
            {
                if (Enum.TryParse(connectionCsv[headers.IndexOf("VNCColors")], out VncColors value))
                    connectionRecord.VNCColors = value;
            }

            if (headers.Contains("VNCSmartSizeMode"))
            {
                if (Enum.TryParse(connectionCsv[headers.IndexOf("VNCSmartSizeMode")], out VncSmartSizeMode value))
