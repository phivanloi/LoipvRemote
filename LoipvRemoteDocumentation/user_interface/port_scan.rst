...
It will scan a range of IP addresses and to determine if specific LoipvRemote supported protocols are active. Hosts can then be bulk imported into LoipvRemote.

.. tip::

    If you leave this at the default of 0 & 0, the test will be for the default protocol ports that LoipvRemote supports.
...
- Enter the Start Port and End Port that LoipvRemote should test for.
- Click Scan
